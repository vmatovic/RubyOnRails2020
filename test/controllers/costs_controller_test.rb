...
class CostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post costs_url, params: { cost: { unit_cost: @cost.unit_cost, unit_price: @cost.unit_price } }
    end
  ...
  test "should update cost" do
    patch cost_url(@cost), params: { cost: { unit_cost: @cost.unit_cost, unit_price: @cost.unit_price } }
