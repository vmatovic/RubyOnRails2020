...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post promotions_url, params: { promotion: { begin_date: @promotion.begin_date, end_date: @promotion.end_date, promo_cost: @promotion.promo_cost, promo_name: @promotion.promo_name } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { begin_date: @promotion.begin_date, end_date: @promotion.end_date, promo_cost: @promotion.promo_cost, promo_name: @promotion.promo_name } }
