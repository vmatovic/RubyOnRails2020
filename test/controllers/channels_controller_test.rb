...
class ChannelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create channel" do
    assert_difference('Channel.count') do
      post channels_url, params: { channel: { classs: @channel.classs, desc: @channel.desc, total: @channel.total } }
    end
  ...
  test "should update channel" do
    patch channel_url(@channel), params: { channel: { classs: @channel.classs, desc: @channel.desc, total: @channel.total } }
